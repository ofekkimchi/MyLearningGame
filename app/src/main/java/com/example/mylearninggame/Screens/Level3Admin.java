...
/**
 * Admin interface for managing Level 3 questions
 * Allows administrators to add, edit, and delete questions for Level 3
 */
public class Level3Admin extends AppCompatActivity {
    // UI Components
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level3_admin);
    ...
    /**
     * Adds a new question to Level 3
    ...
    private void addQuestion() {
        ...
        if (validateInput(word, rightAnswer, wrongAnswer1, wrongAnswer2, wrongAnswer3)) {
            Question question = new Question(null, word, rightAnswer, wrongAnswer1, wrongAnswer2, wrongAnswer3, 3);
            databaseService.createNewQuestion(question, new DatabaseService.DatabaseCallback<Void>() {
                @Override
                public void onCompleted(Void object) {
                    runOnUiThread(() -> {
                        Toast.makeText(Level3Admin.this, "Question added successfully!", Toast.LENGTH_SHORT).show();
                        clearInputs();
                    });
                }
                ...
                public void onFailed(Exception e) {
                    runOnUiThread(() -> {
                        Toast.makeText(Level3Admin.this, "Failed to add question: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
                }
            });
        }
